...
tf.flags.DEFINE_string('checkpoint_dir', 'checkpoints/20170819-2222', 'checkpoints directory path')
tf.flags.DEFINE_string('XtoY_model', 'man2woman1.pb', 'XtoY model name, default: apple2orange.pb')
tf.flags.DEFINE_string('YtoX_model', 'woman2man1.pb', 'YtoX model name, default: orange2apple.pb')
