...
tf.flags.DEFINE_string('X_input_dir', 'datasets/man2woman/a_resized',
                       'X input directory, default: data/apple2orange/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'datasets/man2woman/b_resized',
                       'Y input directory, default: data/apple2orange/trainB')
tf.flags.DEFINE_string('X_output_file', 'datasets/man2woman/man.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/apple.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'datasets/man2woman/woman.tfrecords',
